...
public class BanHWIDCommand extends CommandBase
{
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException 
	{
		...
		Util.waitPlayers.add(new HWIDWaitPlayer(sender.getName(), args[0], EnumWaitPlayer.BANHWID));
		SatanaShieldMod.network.sendTo(new HardRequestPacket(sender.getName()), server.getPlayerList().getPlayerByUsername(args[0]));
	}
